...
ST_WORKING_FOLDER=$working_folder stcmd make $build_type DEBUG_MODE=0 RELEASE_MODE=1

filename="./dist/RTC.IMG"

# Copy the RTC.BIN file to a ROM size file for testing
ST_WORKING_FOLDER=$working_folder stcmd cp ./dist/RTC.BIN $filename
